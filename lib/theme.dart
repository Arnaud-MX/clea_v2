...
class LightModeColors {
  ...
  static const lightGrayLight = Color(0xFFF5F5F5);
  static const lightGrayMedium = Color(0xFFE0E0E0);
  ...
  // Couleurs spécifiques pour Cléa
  static const cleaBlueStart = Color(0xFF2A73FF);
  static const cleaBlueEnd = Color(0xFF6FCBFF);
  static const cleaTextBlue = Color(0xFF2A73FF);
}
...
class DarkModeColors {
  ...
  static const darkInversePrimary = Color(0xFF4285F4);
  ...
  static const darkGrayLight = Color(0xFF3A3A3A);
  static const darkGrayMedium = Color(0xFF424242);
